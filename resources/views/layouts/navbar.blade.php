<div class="bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <a href="/nonAuthHome" style="color:white;font-size:24px;text-decoration:none;" class="font-semibold text-sm sm:text-xl tracking-tight">HUCEPMS</a>
    </div>
    <div class="relative">
        @auth
            ...
            <div class="flex items-center">
                ...
                <div>
                    <a class="flex items-center mr-4 text-sm text-gray-200 font-semibold" href="{{ route('login') }}">
                        {{-- <span>Applay</span> --}}
                        <a href="/applicationForm" style="margin-right:10px;" class="btn btn-success">Applay</a>
                    </a>
                </div>
                <div>
                    <a class="flex items-center mr-4 text-sm text-gray-200 font-semibold" href="{{ route('login') }}">
