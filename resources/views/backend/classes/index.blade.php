...
@section('content')
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h4 class="text-gray-700 uppercase font-bold">Classes (Departements)</h4>
            </div>
        ...
        <div class="container-fluid" style="padding:0px;">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10"><h6>Collage of Bussiness and Economics (Masters, Regular)</h6></div>
                        <div class="col-sm-2 text-right"><a class="btn btn-secondary btn-sm" href="#">Add Departement</a></div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card" style="margin-top:50px;">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10"> <h6>Collage of Agricultural and Environmental Science (Undergraduate, Summer)</h6></div>
                        <div class="col-sm-2 text-right"><a class="btn btn-secondary btn-sm" href="#">Add Departement</a></div>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-hover text-center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">3</th>
                            <td>Natural Resouce Management</td>
                            <td>4</td>
                            <td><a href="#" class="btn btn-success btn-sm" style="width:60px;">Edit</a><a style="margin-left:10px;" class="btn btn-danger btn-sm"href="#">Delete</a></td>
                          </tr>
                        </tbody>
